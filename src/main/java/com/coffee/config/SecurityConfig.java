...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // HttpSecurity : 개발자가 코드를 직접 작성하여 보안 정책을 설정하 수 있도록 도와 주는 객체입니다.
        http
        ...
        // 참고 : .logoutSuccessHandler()도 있음.  로그아웃시 수행할 동작
        http.logout(logout -> logout
                .logoutUrl("/member/logout") // 로그 아웃이 이동할 url
                .permitAll() // 누구든지 접근 허용
    ...
    @Bean // CorsConfigurationSource는 다른 도메인(origin)에서 자원 요청시 브라우저가 허용 여부를 검사해주는 보안 정책 입니다.
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        /*
            백엔드 : 리엑트에서 쿠키, 세션 정보를 넘기면 허용하기 위한 욥션
            프론트엔드 = axios를 사용할 떄 반드시 'withCredentials : true' 옵션을 명시하도록 할 것
