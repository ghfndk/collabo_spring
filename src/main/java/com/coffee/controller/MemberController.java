...
@RestController // 해당 클래스는 웹 요청(form react)을 접수하여 처리해주는 컨트로럴 클래스입니다.
...
public class MemberController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<?> signup(@Valid @RequestBody Member bean, BindingResult bindingResult) { // 회원가입을 위한 컨트롤러 메소드 -- bean은 유의미한 데이터를 뜻함
        ...
        // Valid 와 BindingResult는 반드시 같이 적어줘야 한다.
