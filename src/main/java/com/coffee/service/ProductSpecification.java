...
// Specification : JPA의 Creteria API를 사용하여 where 절(검색 조건)을 객체 지향적으로 만들기 위하여 사용되는 인터페이스 입니다.
...
public class ProductSpecification {
    ...
    */
    ...
    /*
         상품 상세 설명에 특정 키워드가 포함된 상품 목록만 필터링해주는 Specification입니다.
         keyword : 상품 상세 설명에 포함될 키워드
         반환 값 : 상품 상세 설명에 해당 키워드가 포함된 상품 목록을 조회하기 위한 Specification 객체 정보
    */
